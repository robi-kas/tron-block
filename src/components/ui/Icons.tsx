...
export const ArrowGreenLeft = () => (
  <svg viewBox="0 0 100 100" className="w-[80px] h-[80px] md:w-[130px] md:h-[130px] text-[#CCFF00] stroke-current overflow-visible" fill="none" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round">
